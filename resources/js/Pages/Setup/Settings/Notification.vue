...
const liveChatSettings = props.data.liveChatSettings;
...
const selectedType =
    types.value.find(t => t.code === liveChatSettings?.data?.type) ||
    types.value[0];
...
const form = useForm({
    type: selectedType,
    pusher_app_id: liveChatSettings?.data?.pusher_app_id ?? '',
    pusher_app_key: liveChatSettings?.data?.pusher_app_key ?? '',
    pusher_app_secret: liveChatSettings?.data?.pusher_app_secret ?? '',
    pusher_host: liveChatSettings?.data?.pusher_host ?? '',
    pusher_port: liveChatSettings?.data?.pusher_port ?? '',
    pusher_scheme: liveChatSettings?.data?.pusher_scheme ?? 'https',
    pusher_app_cluster: liveChatSettings?.data?.pusher_app_cluster ?? '',
    ably_key: liveChatSettings?.data?.ably_key ?? '',
});
