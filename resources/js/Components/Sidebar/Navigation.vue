...
<template>
                            ...
                            <div class="relative h-full p-3">
                                ...
                                <CommonIcon :icon="subItem?.active
                                    ...
                                    " :class="[
                                        ...
                                        'h-4 w-4 shrink-0 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2',
                                    ]" />
                            </div>
                            <CommonLink class="items-center"
    ...
    <li class="mt-auto">
        <CommonLink customClass="hover:bg-primary-950 !items-start !py-2 !px-3 !w-full !text-sm !font-medium"
            inActiveClass=" text-light items-center !font-semibold hover:!bg-primary-950 hover:text-light "
            activeClass="bg-light text-primary-950  items-center hover:!bg-light hover:text-primary-950"
            :href="usePage().props?.setup?.url" :active="usePage().props.setup.isSetup">
            <CommonIcon class="h-6 w-6 shrink-0 text-light group-hover:text-light"
